...
### What is in there
This GitHub repository is just a simple program calling an external rest api with http module.
...
### How to make it run
```
git clone https://github.com/mustapha-benmbarek/nodejs-http-client
